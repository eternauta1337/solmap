const SourcemapUtil = {
  ...
  disassemblerRangeToSourceRange(content, range, srcmap) {
    console.log(`source len: `, content.length);
    ...
    console.log(`instructionRange`, instructionRange);

    // Decompress srcmap.
    console.log(`srcmap raw: `, srcmap);
    srcmap = SourcemapUtil.decompressSourcemap(srcmap);
    console.log(`srcmap: `, srcmap, srcmap.length);
  ...
  decompressSourcemap(srcmap) {
    ...
    console.log(`raw srcmap len: `, mappings.length);
